...
% Napisać że program byl uruchamiany na windowsie,
% potrzebne sa trzy zmienne środowiskowe
% FILE_PATH_CONFIG
% FILE_PATH_TEST
% FILE_PATH_PLOT
% Mozna opisac skrypt ucuchamiajacy, zaciagajacy wszystkie biblioteki i instalujacy program
...
% podczas budowania konfiguracji

\subsection{Strategia}
% wszystko to strategia

\section{Pseudokod algorytmu Quick Merge Sort}
% napisać że jest to najważniejszy algorytm w programie