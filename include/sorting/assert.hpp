...
#ifndef NDEBUG_ALWAYS
	#define always_check_nums_are_equal(A, B)		__check_nums_are_equal(A, B)
	#define always_check_addition_overflow(S, N)	__check_addition_overflow(S, N)
#else
	#define always_check_nums_are_equal(A, B)
	#define always_check_addition_overflow(S, N)
#endif
