...
W pracy badano algorytm QuickMerge Sort, którego koncepcja została opisana przez Sebastiana Wilda w publikacji \boldquotes{QuickXsort – A Fast Sorting Scheme in Theory and Practice} \cite{QuickXsort}. Informacje na temat tego algorytmu można znaleźć również w pracach \boldquotes{QuickMergesort: Practically Efficient Constant-Factor Optimal Sorting} \cite{QuickMergesort1} oraz \boldquotes{Worst-Case Efficient Sorting with QuickMergesort} \cite{QuickMergesort2}, których autorami są Stefan Edelkamp i Armin Weiß.\\

Kolejnym badanym algorytmem był Intro Sort. Informacje na ten temat znaleźć w publikacji \boldquotes{Pattern-defeating Quicksort} \cite{IntroSort} autorstwa Orsona R. L. Petersa.\\
