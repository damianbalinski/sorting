...
\begin{itemize}
	...
	\item \BOLD{mediana-median z pięciu} - elementy tablicy są grupowane z zbiory 5-elementowe, z każdego zbioru wybierana jest mediana, następnie algorytm jest wywoływany rekurencyjnie dla wybranych elementów,
	\item \BOLD{mediana-median z trzech} - tablica jest dzielona na trzy równe części, w każdej z części rekurencyjnie wyszukiwana jest mediana, następnie zwracana jest mediana z otrzymanych wyników.\\
\end{itemize}
