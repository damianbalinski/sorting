...
Badając rozkład prawdopodobieństwa liczby wykonanych operacji dla algorytmów randomizowanych (\ref{fig:quick-sort-nondeterministic-pivot-density}),
% metoda hoarego skutecznie zmiejsza odchylenie standartowe.
