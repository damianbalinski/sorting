...
% Niedeterministyczny wybor pivota, motywacja, losowosc moze sie przydac
% badanie dla tych samych algorytmow partycjonowania co poprzednio

% Badano nastepujace metody wyboru pivota
% losowy pivot
% power of three choices - wariant metody power of two choices, mediana z trzech losowo wybranych liczb
% randomizowana pseudo-mediana z dziewieciu
