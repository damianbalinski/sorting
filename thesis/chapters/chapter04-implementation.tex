...
spreparowanych danych, które dany przypadek spowodują. Aby to osiągnąć, dane testowe są generowane za pomocą \BOLD{obiektów-strategii}. W zależności od zestawu testowego, używana jest inna strategia generowania danych, co przekłada się na późniejsze wyniki testowania.
...
% w trakcie budowania konfiguracji używany jest budowniczy
