...
\begin{figure}[H]
	\centering
	\includesvg[inkscapelatex=false,width=0.6\columnwidth]{img/uml/facade-class-diagram.svg}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includesvg[inkscapelatex=false,width=0.20\columnwidth]{img/uml/value-object-class-diagram.svg}
\end{figure}
